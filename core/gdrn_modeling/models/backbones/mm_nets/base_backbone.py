...
class BaseBackbone(nn.Module, metaclass=ABCMeta):
    ...
    This class defines the basic functions of a backbone. Any backbone
    that inherits this class should at least define its own `forward`
    function.
    """
    ...
    def init_weights(self, pretrained=None):
        ...
        if isinstance(pretrained, str):
            ...
            raise TypeError("pretrained must be a str or None." f" But received {type(pretrained)}.")
